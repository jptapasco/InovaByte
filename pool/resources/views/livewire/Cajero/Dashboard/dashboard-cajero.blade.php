<div>
    ...
    <h1 class="text-success">Productos</h1>
        <select class="form-select" name="selectCategoria" aria-label="Default select example" wire:model="categoriaSeleccionada" wire:change="actualizarProductos">
                ...
                <div class="col-md-6 col-lg-3 col-sm-12 mb-4 ">
                    <div class="card border-success-subtle ">
                        ...
                        <div class="card-body text-center">
                            ...
                            <button class="btn btn-outline-success" wire:click="agregarProducto({{ $producto->id }})">Agregar</button>
                        </div>
                    </div>
                </div>
                @empty
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <button wire:click="disminuirCantidad({{ $index }})" class="btn btn-danger" type="button">-</button>
