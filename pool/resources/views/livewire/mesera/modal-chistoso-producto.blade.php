<x-modal title="Productos para el cliente" id="modalChistoso" size="xl">
    <div class="bg-light card p-5 my-3">
        ...
        @if ($productosSeleccionados)
            <div class="text-center">
                <button wire:click="sumarAFactura" class="btn btn-success mb-5 btn-lg"><i class="fa-solid fa-file-invoice-dollar"></i> Facturar</button>
            </div>
        @else
            <div class="text-center">
